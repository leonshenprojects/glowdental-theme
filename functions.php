...
function minim_child_enqueue_styles() {
    ...
    wp_enqueue_style( 'generic-styles', get_theme_file_uri('/css/generic.css'), array(), '1.0' );
    ...
    wp_enqueue_style( 'custom-form-styles', get_theme_file_uri('/css/customForm.css'), array(), '1.0' );

    wp_enqueue_script( 'custom-contactForms-scripts', get_theme_file_uri('/js/contactForms.js'), array(), date(), true );
