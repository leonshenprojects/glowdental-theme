...
function minim_child_enqueue_styles() {
    ...
    wp_enqueue_style( 'custom-team-styles', get_theme_file_uri('/css/team.css'), array(), '1.0' );

    wp_enqueue_script( 'custom-contactForms-scripts', get_theme_file_uri('/js/contactForms.js'), array(), '1.5', true );
